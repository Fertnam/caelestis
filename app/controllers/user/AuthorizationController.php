<?php
	...
	class AuthorizationController {
		...
		public function actionSite($username, $password) {
			...
			// $result = ['success' => false, 'comment' => Phraser::getSingleton()->getPhrase('user_successful_authorization')];

			// try {
			 	//$AuthAttempt = AuthAttempt::actualOrCreate($_SERVER['REMOTE_ADDR']);
			 	//$AuthAttempt->upgrade();

				echo User::where('username', 'fox')->first()->authOnSite();
			 	//print_r($AuthAttempt);
